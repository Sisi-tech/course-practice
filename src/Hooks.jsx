...
export default function InputComponent() {
    ...
    return (
        <div className='text-gray-100 py-2 flex flex-col justify-center align-center' style={{lineHeight: "2.0"}}>
            ...
            <p>Happy Thanksgiving {name} ⸜(｡˃ ᵕ ˂ )⸝♡</p>
            <input className='block bg-gray-200 text-black px-2 rounded-md' placeholder='Type your name here ִ ࣪𖤐 ' value={name} onChange={handleNameChange} />
